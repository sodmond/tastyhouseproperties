...
use App\Http\Controllers\THC\Seller as SellerBackend;
...
Route::group(['middleware' => ['auth:seller', 'verified', 'seller.type']], function () {
    ...
    //Route::post('product/{id}/update-image', [SellerBackend\ProductController::class, 'updateImage'])->name('product.update.image');
    ...
    Route::get('addons-group', [SellerBackend\AddonGroupController::class, 'index'])->name('addons_group');
    Route::get('new-addons-group', [SellerBackend\AddonGroupController::class, 'new'])->name('addons_group.new');
    Route::post('new-addons-group', [SellerBackend\AddonGroupController::class, 'addNew']);
    Route::get('addons-group/{id}/edit', [SellerBackend\AddonGroupController::class, 'edit'])->name('addons_group.edit');
    Route::post('addons-group/{id}/update', [SellerBackend\AddonGroupController::class, 'update'])->name('addons_group.update');
    ...
    Route::get('orders', [SellerBackend\OrderController::class, 'index'])->name('orders');
    Route::get('order/{id}', [SellerBackend\OrderController::class, 'get'])->name('order');
