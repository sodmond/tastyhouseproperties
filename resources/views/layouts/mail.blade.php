...
<head>
    ...
    <style type="text/css">
        ...
        .order-table {
            background-image: url('{{ asset('img/order-poster.jpg') }}');
        ...
        .footer-table::before {
            position: absolute;
            content: "";
            background-image: url('{{ asset('img/footer-left.svg') }}');
        ...
        .footer-table::after {
            position: absolute;
            content: "";
            background-image: url('{{ asset('img/footer-right.svg') }}');
            background-position: top right;
            top: 0;
            right: 0;
            width: 100%;
            ...
            <tr>
                <td>
                        ...
                        <tr class="header"
                            ...
                            <td class="header-logo" style="padding: 10px 32px;">
                                <a href="../front-end/index.html" style="display: block; text-align: left;">
                                    <img src="{{ asset('img/logo.png') }}" class="main-logo" alt="logo" style="width:200px;">
                                </a>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table style="padding: 27px;" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('img/order-success-poster.png') }}" alt="" style="width: 100%; height: 100%;">
                            </td>
                        </tr>
                    </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="www.pinterest.com">
                                                <img src="{{ asset('img/pinterest.png') }}"
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);"
                                                    alt="">
                                            </a>
                                        </td>
