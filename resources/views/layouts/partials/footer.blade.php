<footer class="footer-sm" style="background-color:#f8f8f8;">
                    ...
                    <div class="footer-logo">
                        ...
                        <div class="footer-logo-contain">
                            <p>We believe that selling online should be simple, fair, and rewarding.
                                Tastyhouse Properties gives you the tools and visibility you need to succeed. 
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <li>
                                <div class="footer-number">
                                    ...
                                    <div class="contact-number">
                                        ...
                                        <h5>support@tastyhouseproperties.com</h5>
                                    </div>
                                </div>
                            </li>
