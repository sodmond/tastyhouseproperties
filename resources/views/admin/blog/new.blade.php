@extends('admin.layouts.main', ['title' => 'New Article', 'activePage' => 'blog'])
                        ...
                        <div class="card-body">
                            <div class="title-header option-title">
                                ...
                                <form class="d-inline-flex">
                                    <a href="{{ route('admin.blog') }}" class="align-items-center btn btn-theme d-flex">
                                        <i class="fa fa-newspaper"></i> All Articles
                                    </a>
                                </form>
                            </div>
                            ...
                            <div class="theme-form theme-form-2 mega-form">
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="datetime-local" name="published_at" id="published_at" value="{{ old('published_at') ?? now() }}" required>
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
