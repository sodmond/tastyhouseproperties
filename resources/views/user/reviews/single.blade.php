@extends('layouts.app', ['title' => 'Review', 'activePage' => 'user.reviews'])
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <div class="form-floating theme-form-floating">
                                            <input class="form-control" value="{{ $review->seller->companyname ?? $review->seller->firstname.' '.$review->seller->lastname }}" readonly>
                                            <label>Vendor</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-4">
                                    ...
                                    <div class="col mb-4 pt-3" style="border-top:1px solid #dcdcdc;">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($images as $image)
                                                <div class="col-md-4">
                                                    <a href="{{ asset('storage/reviews/'.$image) }}" target="_blank" style="cursor:pointer;">
                                                        <img class="img-fluid" src="{{ asset('storage/reviews/'.$image) }}" alt="">
                                                    </a>
                                                </div>
                                            @endforeach
                                        </div>
