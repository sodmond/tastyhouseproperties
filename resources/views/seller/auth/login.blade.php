@extends('layouts.app', ['title' => 'Vendor Login', 'activePage' => 'seller.login'])
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                <div class="log-in-box">
                        ...
                        <form class="row g-4" method="POST">
                            ...
                            <div class="col-12">
                                <div class="forgot-box">
                                    ...
                                    <a href="{{ route('seller.password.request') }}" class="forgot-password">Forgot Password?</a>
                                </div>
                            </div>
                    ...
                    <div class="sign-up-box">
                        ...
                        <a href="{{ route('seller.register') }}">Sign Up</a>
                    </div>
                </div>
            </div>
        </div>
