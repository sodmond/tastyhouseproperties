...
class ProductController extends Controller
{
    public function index()
    {
        if (isset($_GET['search'])) {
            ...
            return view('admin.thc.products.index', compact('products'));
        }
    ...
    public function get($id)
    {
        ...
        return view('admin.thc.products.single', compact('product'));
    }
    ...
    public function new()
    {
        ...
        $states = State::all();
        return view('admin.thc.products.new', compact('categories', 'states'));
    }
    ...
    public function trash($id)
    {
        ...
        return redirect()->route('admin.thc.products');
    }
    ...
    public function abuseReports($id)
    {
        ...
        return view('admin.thc.products.reports', compact('product', 'abuse_reports'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.thc.products.edit', compact('product', 'categories', 'cat_choice', 'states', 'cities'));
    }
}
